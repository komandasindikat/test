...
$(document).ready(function () {
    ...
    $(".btnGonder").click(function () {
        ...
        if (AdSoyad == "") {
            $(".txtAdSoyad").val("").attr("placeholder", "Ad Soyad Bos Gecilemez...");
            return false;
        }

        if (Email == "") {
            $(".txtEMail").val("").attr("placeholder", "E-Mail Bos Gecilemez...");
            return false;
        }

        if (Telefon == "") {
            $(".txtTelefon").val("").attr("placeholder", "Telefon Bos Gecilemez...");
            return false;
        }

        if (Mesaj == "") {
            $(".txtMesaj").val("").attr("placeholder", "Mesaj Bos Gecilemez...");
            return false;
        }
        ...
        if (pattern.test(Telefon) == false) {
            $(".txtTelefon").val("").attr("placeholder", "Lutfen Gecerli Telefon Girisi Yapiniz...");
            return false;
        } else {
            if (isValidEmailAddress(Email)) {
                MailGonder(AdSoyad, Email, Telefon, Mesaj);

            } else {
                $(".txtEMail").val("").attr("placeholder", "Gecersiz E-posta girisi...");
                return false;
            }
        }
...
function MailGonder(AdSoyad, Email, Telefon, Mesaj) {
    $.ajax({
        type: "POST",
        url: "/WSMethod.aspx/MailGonder",
